...
namespace TicTacToe
{
    public static class UIMethods
    {
            public static void DisplayWelcomeMessage()
            {
                ...
                Console.Write($"EASY MODE = {(int)GameMode.Easy} and DIFFICULT MODE = {(int)GameMode.Difficult} ({(int)GameMode.Easy}/{(int)GameMode.Difficult})?:\t");
            }
            ...
            public static GameMode ChooseGameMode()
            {
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Enum.IsDefined(typeof(GameMode), parsedValue))
                            {
                                gameMode = (GameMode)parsedValue;
                                validInput = true;
                            }
                            else
                            {
                                Console.Write($"Please enter either {(int)GameMode.Easy} or {(int)GameMode.Difficult}:\t");
                            }
                        }
                        else
                        {
                            Console.Write($"Please enter a valid number ({(int)GameMode.Easy} / {(int)GameMode.Difficult}):\t");
                        }
                    }
                } while (!validInput);
                Console.WriteLine();
